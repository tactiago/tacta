...
import { formatPriceInPtBR } from "../gifts/card"
...
export default function CountryCard({ imageSrc, title, price, selected = false, sumToTotal }: cardProps) {
  ...
  return (
    <div
      ...
      className="border border-dashed hover:border-primary overflow-hidden w-60 max-w-60 h-auto flex flex-col aria-selected:border-emerald-400 aria-selected:border-solid aria-selected:bg-emerald-50 rounded-t-full"
